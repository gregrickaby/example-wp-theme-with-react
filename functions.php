...
function grd_scripts() {
	...
	// Enqueue theme style.
	wp_enqueue_style( 'grd-theme-style', get_stylesheet_directory_uri() . '/build/index.css', [], $asset_file['version'] );

	// Enqueue theme script.
	wp_enqueue_script( 'grd-theme-script', get_stylesheet_directory_uri() . '/build/index.js', $asset_file['dependencies'], $asset_file['version'], true );
